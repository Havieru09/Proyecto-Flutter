...
async function submitNuevoSalon() {
    ...
    if (salon != "") {
        const respuesta = await fetch("http://localhost:3000/aulas_nombre/" + salon);
...
function mostrarGrafico() {
    ...
    // Llama a la función drawChart cuando la librería haya cargado
    google.charts.setOnLoadCallback(drawChart);

    // Define la función drawChart para crear y mostrar el gráfico
    function drawChart() {

        // Crea los datos del gráfico
        var data = google.visualization.arrayToDataTable([
            ['Solicitudes', 'Abrir puertas'],
            ['completas', 11],
            ['en camino', 2],
            ['pendiente', 2],
            ['terminadas', 2],
        ...
        var options = {
            title: 'Solicitudes de 2023 a 2025',
            is3D: true,
            fontSize: 16
        };
    ...
    // -----------------------------------------------
    // const data = [
    //     { fecha: '2022-01-01', tipo: 'A', cantidad: 5 },
    //     { fecha: '2022-01-02', tipo: 'B', cantidad: 10 },
    //     { fecha: '2022-01-03', tipo: 'A', cantidad: 15 },
    //     { fecha: '2022-01-04', tipo: 'C', cantidad: 20 },
    //     { fecha: '2022-01-05', tipo: 'A', cantidad: 25 },
    //     { fecha: '2022-01-06', tipo: 'B', cantidad: 30 },
    //     { fecha: '2022-01-07', tipo: 'C', cantidad: 35 },
    // ];

    // // 2. Filtrar los datos según el rango de fecha desde-hasta y el tipo de solicitud seleccionado
    // const fromDate = '2022-01-01';
    // const toDate = '2022-02-09';
    // const selectedType = 'A';

    // const filteredData = data.filter((d) => {
    //     return d.fecha >= fromDate && d.fecha <= toDate && d.tipo === selectedType;
    // });
    ...
    //     chartData.push([d.fecha, d.cantidad]);
    // });
    ...
    //     const options = {
    //         title: `Solicitudes de tipo ${selectedType} desde ${fromDate} hasta ${toDate}`,
    //         hAxis: {
    //             title: 'Fecha',
