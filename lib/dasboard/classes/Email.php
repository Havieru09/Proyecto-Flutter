...
class Email
{
    ...
    public function enviarConfirmacion()
    {
        ...
        $contenido = '<html>';
        $contenido .= "<p><strong>Hola ". $this->nombre. " </strong> Has Creado tu cuenta en upTask, solo debes confirmara en el siguiente enlace</p>";
        $contenido .= "<p>Presiona aquí: <a href='http://localhost:3000/confirmar?token=".  $this->token.  "'>Confirma Cuenta</a></p>";
        $contenido .= 'Si tu no creaste esta cuenta puedes ignorar el mensaje';
        $contenido .= '</html>';
